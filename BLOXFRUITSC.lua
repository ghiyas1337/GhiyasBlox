...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Ghiyas Hub BF Premium') then
        makefolder('Ghiyas Hub BF Premium')
    end
    if not _G.Dis and not isfile('Ghiyas Hub BF Premium/'..Name..'.json') then
        writefile('Ghiyas Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Ghiyas Hub BF Premium') and isfile('Ghiyas Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Ghiyas Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("Ghiyas",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
